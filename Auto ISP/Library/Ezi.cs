...
namespace Auto_Attach.Library
{
    ...
    class IO
    {
       // private EziMOTIONPlusRLib.ITEM_NODE ITEM_NODE = new EziMOTIONPlusRLib.ITEM_NODE();
      ...
      //  [DllImport("EziMOTIONPlusR.dll")]
        ...
        [DllImport("EziMOTIONPlusR.dll")]
        public static extern int FAS_PosTableReadItem(byte nPortNo, byte iSlaveNo, ushort wItemNo, byte[] lpItem);
    /*   public static int FAS_PosTableReadItem(byte nPortNo, byte iSlaveNo, ushort wItemNo, ref ITEM_NODE Item)
        ...
        [DllImport("EziMOTIONPlusR.dll")]
        public static extern int FAS_MoveToLimit(byte nPortNo, byte iSlaveNo, uint lVelocity, byte iLimitDir);
        [DllImport("EziMOTIONPlusR.dll")]
